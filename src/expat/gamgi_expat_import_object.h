/************************************************
 *
 * $GAMGI/src/expat/gamgi_expat_import_object.h
 *
...
void gamgi_expat_import_object_end (void *data, const char *element);

void gamgi_expat_import_object_start (void *data, const char *element, 

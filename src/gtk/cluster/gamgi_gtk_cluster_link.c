/***************************************************
 *
 * $GAMGI/src/gtk/cluster/gamgi_gtk_cluster_link.c
 *
 ...
 *                       STATIC_RESET                   *
 *                                                      *
 * Reset the cluster link dialog, cleaning all entries. *
 *                                                      *
 ********************************************************/
...
/**********************************
 * reset cluster and object names *
 **********************************/
 ...
 *                 STATIC_LIST             *
 *                                         *
 * Makes the cluster entry sensitive when  *
...
if (cache.above == TRUE)
  {
  /*******************************************
   * link above: link each listed cluster    *
  ...
  {
  /****************************************************
   * link below: link each listed cluster (parent) to *
...
/*************************************************************************
 * link above: link selected cluster (child) to selected object (parent) *
 * link below: link selected cluster (parent) to selected object (child) *
 *************************************************************************/

if (cache.above == TRUE)
  { child = GAMGI_CAST_OBJECT cluster; parent = cache.object; }
else
  { child = cache.object; parent = GAMGI_CAST_OBJECT cluster; }
...
/**************** external function ****************
 *                                                 *
 *           GAMGI_GTK_CLUSTER_LINK_PRESS          *
 *                                                 *
 ***************************************************/

void gamgi_gtk_cluster_link_press (gamgi_window *window_mouse,
...
/******************* external function ****************
 *                                                    *
 *                 GAMGI_GTK_CLUSTER_LINK             *
 *                                                    *
 * Creates the dialog window used to create clusters. *
 *                                                    *
 ******************************************************/

void gamgi_gtk_cluster_link (GtkWidget *widget, void *data)
{
gamgi_window *window = GAMGI_CAST_WINDOW data;
GtkWidget *dialog;
GtkWidget *notebook;
...
dialog = gamgi_gtk_dialog_task0_create ("Cluster Link", window);
window->action = GAMGI_GTK_CLUSTER_LINK;

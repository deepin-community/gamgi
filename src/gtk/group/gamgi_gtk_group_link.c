/***********************************************
 *
 * $GAMGI/src/gtk/group/gamgi_gtk_group_link.c
 *
 ...
 *                     STATIC_RESET                   *
 *                                                    *
 * Reset the group link dialog, cleaning all entries. *
 *                                                    *
 ******************************************************/
 ...
 *                 STATIC_LIST             *
 *                                         *
 * Makes the group entry sensitive when    *
...
if (cache.above == TRUE)
  {
  /*******************************************
   * link above: link each listed group      *
  ...
  {
  /**************************************************
   * link below: link each listed group (parent) to *
...
/***********************************************************************
 * link above: link selected group (child) to selected object (parent) *
 * link below: link selected group (parent) to selected object (child) *
 ***********************************************************************/

if (cache.above == TRUE)
  { child = GAMGI_CAST_OBJECT group; parent = cache.object; }
else
  { child = cache.object; parent = GAMGI_CAST_OBJECT group; }
...
/**************** external function ****************
 *                                                 *
 *            GAMGI_GTK_GROUP_LINK_PRESS           *
 *                                                 *
 ***************************************************/

void gamgi_gtk_group_link_press (gamgi_window *window_mouse,
...
/****************** external function ***************
 *                                                  *
 *                 GAMGI_GTK_GROUP_LINK             *
 *                                                  *
 * Creates the dialog window used to create groups. *
 *                                                  *
 ****************************************************/

void gamgi_gtk_group_link (GtkWidget *widget, void *data)
{
gamgi_window *window = GAMGI_CAST_WINDOW data;
GtkWidget *dialog;
GtkWidget *notebook;
...
dialog = gamgi_gtk_dialog_task0_create ("Group Link", window);
window->action = GAMGI_GTK_GROUP_LINK;
